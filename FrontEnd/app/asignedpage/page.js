      ...
      <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden">
        <div className="px-6 py-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Review or continue your assigned texts</p>
          </div>
          ...
          <table className="w-full table-auto text-sm sm:text-base">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan="5" className="text-center px-6 py-6 text-gray-500 dark:text-gray-400">
                ...
                savedText.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 border-b space-x-2 flex items-center">
                      <button
                        onClick={() => {
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-1.5 px-3 rounded-md shadow-sm transition"
                      >
                        Start
                      </button>
                      <Trash
